...
The html code acts as the skelton and structure of the webpage. With html code we can easily create a website template that is viewable within a broswer (example).
similarly coding our table in html within will give us a structure to display our data through. 

creating a simple web page with a table: 
...
appropriatly coding a table will yeild a structured result that matches the data file parameters. 
