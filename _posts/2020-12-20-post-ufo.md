...
Our third function filters the table by matching the values of our filters array with the rows of data. The filtered data is then parsed by the buildtable function, effectivly displaying a new (and fitlerred) table within the webpage. 
