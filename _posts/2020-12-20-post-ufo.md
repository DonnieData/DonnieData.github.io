...
<div class="notice"> 
  <b>Note:</b> This example includes a sample row of data. However the actual body of the table(<tbody></tbody>) will be left empty since the script will input the data a itself.<br/>
...
<div style="align-items: center;"><a href="https://donniedata.github.io/UFOs/"><button style="color:#636769; background-color:white; border: 2px solid gray; padding: 7px; border-radius: 3px;" type="button"
