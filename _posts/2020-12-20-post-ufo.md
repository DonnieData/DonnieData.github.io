...
Lastly, we need to add our file locations to our html webpage. The file locations should reflect the framework of the application and its relative locations to index.html 
