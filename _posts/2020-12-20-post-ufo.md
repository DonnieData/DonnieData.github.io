...
These will help with the design and responsive of the web page components. 


# Building The Application 
With the main focus of this application and project is to share data, I will focus on the construction of the table that will display the data as well as the form that will allow user input. 
