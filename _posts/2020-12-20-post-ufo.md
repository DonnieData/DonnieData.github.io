...
Adding the link to D3.js allows the library to "listen" in on our code, or react to user input. For example, if we did not add this link, our d3.select section of code in app.js wouldn't know where to insert data. <br>
Link rerference: [cdnpkg.com/d3](https://www.cdnpkg.com/d3) <br> 
[More on CDNs](https://www.imperva.com/learn/performance/what-is-cdn-how-it-works/) {: .notice--info}

Finally we can test our Application and its functionality. Upon opening the index.html file in our web broswer, we can see that all of our data has been inserted into the once blank table. 

![app_test_1](/assets/images/ufo/app_test_1.pmg)


Testing the filter ability: 
