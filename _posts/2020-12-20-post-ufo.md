...
### Further Development 
With all great projects and aplications, there is always room for imporvement and further development. This is especially the case in tech, in which new tools and features are consisitly made available. 
...
The application itself was meant to be quite versatile and reusable. Its thanks to this that the code can be easily refactored to fit many data sources and forms. 
