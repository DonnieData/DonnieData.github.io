...
similarly coding our table in html will give us a structure to display our data through. 
...
> Note: This example includes a sample row if data. However the actual body of the table(<tbody></tbody>) will not be hard coded with data since the script will do that for me. 
