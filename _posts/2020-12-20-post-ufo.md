...
As aforemention, Javascript and HTML go hand-in-hand, becuase this, there are many tools at our disposal when working with HTML, namely the javasript library [D3.Js](https://d3js.org/).
...
<b>data.js</b><br> 
In order to have data readyly available for testing and parsing, I have sample data(on UFO sightings) in [JSON](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Objects/JSON) format for easy parsing.
...
<div class="notice"> 
  <b>Note:</b> This example includes a sample row of data. However the actual body of the table(<tbody></tbody>) will be left empty since the script will input the data a itself.
</div>
...
> <b>3.filter data</b>
  ...
  > b. insert filtered data into table to be dispalyed <br>
...
Ex: 
<img src="/assets/images/ufo/html_id.png">,<img src="/assets/images/ufo/html_form_input.png">
...
<figure class="half">
  ...
  <a href="/assets/images/ufo/data_excerpt.png"><img src="/assets/images/ufo/data_excerpt.png"></a>
  <a href="/assets/images/ufo/data_excerpt.png"><img src="/assets/images/ufo/table_excerpt.png"></a>
</figure>
...
<br/>
<div class="notice">
  <b>Note:</b> File locations and organization is extremly important. When changing the location of files (eg. data.js, app.js) please make sure to update code within within Javascript and hmtl that points to where they are. 
</div>
...
<b>Note:</b> Adding the link to D3.js allows the library to "listen" in on our code, or react to user input. For example, if we did not add this link, our d3.select section of code in app.js wouldn't know where to insert data. <br>
  <a href="https://www.cdnpkg.com/d3"><b>D3.js CDN Link rerference</b></a><br> 
  <a href="https://www.imperva.com/learn/performance/what-is-cdn-how-it-works/"><b>More on CDNs</b></a>
   </div>


<br/>
<p>Finally we can test our Application and its functionality. Upon opening the index.html file in our web broswer, we can see that all of our data has been inserted into the once blank table.</p> <br/>


<div class="notice">
 <i>click for enlarged image</i>
<figure>
...
While functionilty is of the upmost importance, so is visualization. Without eye pleasing desing, many if not all users will not be drawn in enough to review the application let alone take the time the to explore and filter the data itself. 

### Style 
<hr>
With our form and table ready to go, all thats left is to add styling and design to the webpage. To build-out my webpage I will be using <i>Bootstraps</i> grid system and css designs along with my personal preferneces for addtional "character". 
Bootstraps grid system makes it easier to apply fluidity, structure and responsiveness to your web page. 
Additionally, using Bootsraps css properties allows for a streamlined experience when desinging.
...
<a href="https://donniedata.github.io/UFOs/"><button style="color:#636769; background-color:white; border: 1.5px solid gray; padding: 7px; border-radius: 3px;" type="button"
onMouseOver="this.style.color='#157198'"
   onMouseOut="this.style.color='#636769'"
><b>View the Web App</b></button></a>
