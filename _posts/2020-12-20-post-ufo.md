...
It is important to note the <b>id's</b> used in the input tags, nested within the forms. These id's and tags as well as tags from our table will be used with D3 and javascript to receive user input and display the matching data. 
</div>
