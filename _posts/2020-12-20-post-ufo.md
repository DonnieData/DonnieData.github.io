...
<u>1.display all of our data within the table</u>
  a. import and parse data 
  b. insert data into table to be displayed

<u>2.filter the data based on user input</u>
  a. check web page for user input 
  b. store user input as Javascript objects, to be used as filters 
  c. use filters as a criteria to remove table rows that do not match the criteria 
  d. insert filtered data into table to be dispalyed 
