...
feature_row:
  ...
  - image_path: /assets/images/nasa.jpg
    ...
    excerpt: "Building a dynamic webpage to display and filter data using JavaScript.<br/> <button><b>[View The Documentation]({% post_url _posts/2020-12-20-post-ufo %})</b></button>"
