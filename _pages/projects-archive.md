...
feature_row:
  - image_path: /assets/images/splash_project/nasa_splash_1.jpg
    ...
    excerpt: <div style="margin:0px; margin-bottom:10px; text-align:center;"> 
                  <button type="button" style="background-color:#FFFFFF; border-radius:3px; border:1px solid gray">HTML</button>
                  <button type="button" style="background-color:#FFFFFF; border-radius:3px; border:1px solid gray">Javascript</button>
                  <button type="button" style="background-color:#FFFFFF; border-radius:3px; border:1px solid gray">D3.js</button>
