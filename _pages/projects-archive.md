...
feature_row:
  ...
  - image_path: /assets/images/nasa.jpg
    ...
    excerpt: 'Building a dynamic webpage to display and filter data using JavaScript.<br/><br/> <button style="padding:15px";><b>[Read More]({% post_url 2020-12-20-post-ufo %})</b></button>'
