...
feature_row:
  - image_path: /assets/images/splash_project/nasa_splash_1.jpg
    ...
    excerpt: <div style="margin:0px; margin-bottom:10px;">
                <button type="button" style="background-color:#073763; color:#FFFFFF; border-radius:25px; border:1px solid gray; font-size:16px; padding-left:13px; padding-right:13px;"><i class="fas fa-calendar-alt"></i> <b>2020</b></button>
